...
- 🟡 Продукти: Базова структура с основни полета
  - Липсват: images relation, product_variants, features relation, shipping полета, pricing детайли
...
**СЛЕДВАЩИ СТЪПКИ:**
1. Имплементиране на Атрибути (за Product Variants)
2. Имплементиране на Характеристики (Features)
3. Обогатяване на Products с липсващите връзки и полета
4. Добавяне на product_images таблица и relation
5. Добавяне на product_variants таблица
6. Разширяване на Products таблица с shipping и pricing полета
